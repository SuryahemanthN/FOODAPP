  ...
  <div tabIndex={0} role="button" className="btn btn-ghost btn-circle mr-3 lg:flex hidden flex items-center justify-center">
      ...
      {user ? (
            ...
            <button
              ...
              className="btn bg-blue rounded-full px-6 flex items-center gap-2"
            >
              <FaUser /> Login
            </button>
          )}
      {/* <button
              className="btn bg-blue rounded-full px-6 flex items-center gap-2" onClick={()=>document.getElementById('my_modal_4').showModal()}
            >
              <FaUser /> Login
            </button> */}
            <Modal/>
